/* Realice el trabajo despues de la primera clase y asumi que no habia limite
para construir el autoretrato, perdon por la exageracion innecesaria */

PImage img; //La variable de imagen es img
...
void setup () { 
    ...
    background (107, 146, 132); //color de fondo verde opaco
     ...
     img = loadImage ("Autoretrato.jpg"); //img equivale a autorretrato.jpg
     image(img, 0, 0, 400, 400 ); //cambie el tamaño para que entre 
    
    //Lo hice mal y dibuje en lado equivocado ;-;
     translate(400, 0);
